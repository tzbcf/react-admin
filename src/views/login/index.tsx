 ...
 * Description : 
 * -----
 * Last Modified: 2020-04-10 11:46:01
 * Modified By : 
 * -----
...
export default class Login extends React.Component<any, {}> {
  ...
  render () {
    return (
      <div className={["flex-center", index.container ].join(' ')} >
        <Form
          name="userInfo"
          initialValues={{ remember: true }}
          onFinish={this.onFinish.bind(this)}
          onFinishFailed={this.onFinishFailed}
          className={index.loginFrom}
        >
          <Form.Item>
          ...
          <Form.Item>
            <Button type="primary" htmlType="submit" className={index.loginFormButton}>登陆</Button>
          </Form.Item>
        </Form>
      </div>
    )
